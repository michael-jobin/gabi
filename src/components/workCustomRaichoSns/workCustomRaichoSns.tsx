import styles from './workCustomRaichoSns.module.scss'

const WorkCustomRaichoSns = () => {
  return (
    <div className={styles.section}>
      <ul className={styles.linkList}>
        <li>
          <a href="https://www.instagram.com/raicho_koraicho/" target="_blank">
        ...
        <li>
          <a href="https://twitter.com/raicho_koraicho" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.5 31.5" className={styles.x}>
              <polygon points="34.5 0 26.54 0 17.25 11.02 7.96 0 0 0 13.27 15.75 0 31.5 7.96 31.5 17.25 20.48 26.54 31.5 34.5 31.5 21.23 15.75 34.5 0" />
            </svg>
            @raicho_koraicho
          </a>
        </li>
...
export default WorkCustomRaichoSns
